...
if room != rm_book {
	...
	{
		if (keyboard_check_pressed(ord("V")) and not swordState and not holdingItem and global.hasMetalSword) {
			drawSword()
		}
		...
		// Move up
		    if(keyboard_check(ord("W")))
		    {
			    ...
			    global.water -= global.waterUseInterval / (room_speed*global.waterUseInterval);
				global.food -= global.foodUseInterval / (room_speed*global.foodUseInterval*3);
